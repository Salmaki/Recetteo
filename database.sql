...
CREATE TABLE IF NOT EXISTS users (
    ...
    email      VARCHAR(255) NOT NULL UNIQUE   COMMENT 'البريد الإلكتروني (فريد)',
    password   VARCHAR(255) NOT NULL          COMMENT 'كلمة المرور المشفّرة',
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT 'تاريخ التسجيل'
...
4. ادمج الخليطين وحرّك حتى يتجانس العجين
...
- 1 كوب ماء بارد
- ثلج حسب الرغبة',
    '1. قشّر المانجو وقطّعها
2. ضعها في الخلاط مع الليمون والسكر والماء
3. اخلط حتى تصبح ناعمة
...
(1, 'أحمد', 'أفضل كيكة شوكولاتة جربتها'),
